  ...
  renderValue: function(el, x, instance) {
    ...
    function makeResponsive(el) {
       ...
       svgContainer.call(zoom);
        ...
        var edgeLabels = svgContainer.selectAll(".edgeLabel").selectAll("span")
                        
        nodes.on("click", function() {          
          Shiny.onInputChange('mermaidnode', this.id);          
          d3.event.stopPropagation();
        }); 
        
        edgeLabels.on("click", function() {                     
          Shiny.onInputChange('mermaidedgelabel', this.innerHTML);      
          d3.event.stopPropagation();
        }); 
